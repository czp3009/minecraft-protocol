...
/**
 * Loads the pre-compiled official codec bridge (produced by the
 * `compileOfficialCodecOracle` Gradle task) and runs the verification inside
 * the test JVM.  No compilation or file lock happens at test time.
 */
