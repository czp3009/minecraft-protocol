...
- Keep portable branch samples and round trips in `commonTest`. The `hostProcessTest` official-server scenario shares
  the portable Ktor transport and `minecraft-test-support` resource across supported host targets; only the reflective
