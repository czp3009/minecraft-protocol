...
abstract class GenerateVanillaRegistryDataSourceTask :
    ...
    fun generate() {
        ...
        val sourceFile = renderSource(
            minecraftVersion = minecraftProtocolTarget.minecraftVersion,
            protocolVersion = minecraftProtocolTarget.protocolVersion,
            vanillaRegistryDataPayload = vanillaRegistryDataPayload,
        ).toString()
    ...
    private fun renderSource(
        ...
        protocolVersion: Int,
        vanillaRegistryDataPayload: String,
    ): FileSpec {
