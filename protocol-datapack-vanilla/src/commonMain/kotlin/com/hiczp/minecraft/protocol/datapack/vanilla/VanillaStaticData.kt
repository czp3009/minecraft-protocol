...
private fun decodeVanillaStaticData(): VanillaStaticDataSnapshot {
    val payloadMinecraftVersion = VanillaStaticDataPayloads.minecraftVersion
    val modelMinecraftVersion = MinecraftProtocol.MINECRAFT_VERSION
    check(payloadMinecraftVersion == modelMinecraftVersion) {
        "Vanilla static data targets $payloadMinecraftVersion, but models target $modelMinecraftVersion"
    }
    val payloadProtocolVersion = VanillaStaticDataPayloads.protocolVersion
    val modelProtocolVersion = MinecraftProtocol.PROTOCOL_VERSION
    check(payloadProtocolVersion == modelProtocolVersion) {
        "Vanilla static data targets protocol $payloadProtocolVersion, but models target $modelProtocolVersion"
    }
