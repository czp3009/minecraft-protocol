...
class PlayerStatisticsStore(
    ...
    fun readJson(playerUuid: String, json: Json = Json): JsonElement =
        utf8JsonFileStore.readJson(minecraftWorldPaths.statistics(playerUuid), json)
    ...
    fun writeJson(playerUuid: String, jsonElement: JsonElement, json: Json = Json) =
        utf8JsonFileStore.writeJson(minecraftWorldPaths.statistics(playerUuid), jsonElement, json)
